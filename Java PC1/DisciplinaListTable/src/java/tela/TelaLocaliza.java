...
public class TelaLocaliza extends javax.swing.JFrame {
    ...
    public void preencheTabela() {
        ...
        List c = bd.pesquisa(txtfiltro.getText());
        for (Iterator it = c.iterator(); it.hasNext();) {
            Disciplina a = (Disciplina) it.next();
            modelo.addRow(new Object[]{a.getCodigo(), a.getNome(), a.getCargahoraria(), a.getProfessor()});
        }
    }
    ...
    private void mAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mAlterarActionPerformed
        ...
        if (tlocaliza.getSelectedRow() != -1) {
            ...
            JOptionPane.showMessageDialog(this, "Não há nenhuma disciplina selecionada");
        }
